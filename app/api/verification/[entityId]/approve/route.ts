...
import { approveVerificationTask } from "@/lib/repositories/store";
...
export async function POST(
  ...
  const task = approveVerificationTask(context.params.entityId, parsed.data.reviewer, parsed.data.note);
  if (!task) {
